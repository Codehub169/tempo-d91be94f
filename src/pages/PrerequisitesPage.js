    ...
    <div className="min-h-screen flex flex-col justify-center items-center p-5">
      <div className="max-w-3xl w-full bg-card-bg rounded-xl shadow-xl p-10 text-left border border-border-color transition-all duration-300 ease-in-out hover:shadow-accent-glow hover:translate-y-[-2px]">
        ...
        <ul className="list-none pl-0 mb-5">
          <li className="bg-code-bg p-4 rounded-lg mb-3 flex items-center border-l-4 border-accent-color shadow-md transition-all duration-200 ease-in-out hover:shadow-accent-glow-sm hover:translate-x-1">
            <span className="text-accent-color font-bold mr-4 text-xl text-shadow-accent">&#10003;</span>
